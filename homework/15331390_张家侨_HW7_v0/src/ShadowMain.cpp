...
void RenderCube();
void SetMenu(GLFWwindow *window, int *lightChoice);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 使用上面生成的深度图，在着色器里进行深度判定，然后判定是否处于阴影中
...
void SetMenu(GLFWwindow *window, int *lightChoice)
{
    ...
    {
        ImGui::Combo("Light Mode", lightChoice, "Ortho\0Perspertive\0");
